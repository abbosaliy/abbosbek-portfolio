...
export default function ProjectCarousel() {
  ...
  return (
    <div className="relative mt-10">
      ...
      <button className="swiper-next absolute right-2 top-1/2 -translate-y-1/2 z-20 bg-white/80 dark:bg-gray-800/80 backdrop-blur text-gray-800 dark:text-gray-200 p-3 rounded-full shadow-md dark:shadow-gray-700/50 hover:scale-110 transition duration-200">
        <FaChevronRight />
      </button>
      ...
      {activeProject && (
        ...
        >
          <div
            className="bg-white dark:bg-gray-900 rounded-xl overflow-hidden max-w-2xl w-full flex flex-col max-h-[90vh] my-auto"
